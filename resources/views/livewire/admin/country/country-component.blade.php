                                ...
                                <tbody>
                                    ...
                                    @if ($countries->count() > 0)
                                        @foreach ($countries as $country)
                                            <tr>
                                                <td>{{ $sl++ }}</td>
                                                <td><img style="height: 40px; width: 40px;" src="{{ $country->flag }}" alt=""></td>
                                                <td>{{ $country->name }}</td>
                                                ...
                                                <td style="text-align: center;">
                                                    <div class="button-items">
                                                        ...
                                                        <a wire:click.prevent="deleteConfirmation({{ $country->id }})" type="button" class="btn btn-outline-danger btn-icon-circle btn-icon-circle-sm"><i class="ti ti-trash"></i></a>
                                                    </div>
                                                </td>
                                            </tr>
                                        @endforeach
                    ...
                    <form wire:submit.prevent="storeData">
                        ...
                        <div class="mb-3 row">
                            <label for="example-tel-input"
                                class="col-sm-3 col-form-label">Phonecode
                                </label>
                            <div class="col-sm-9">
                                <input class="form-control" type="number" wire:model="phonecode" placeholder="Enter rate" />
                                @error('phonecode')
                                    <span class="text-danger" style="font-size: 12.5px;">{{ $message }}</span>
                                @enderror
                            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form wire:submit.prevent="updateData">
                        ...
                        <div class="mb-3 row">
                            <label for="example-number-input" class="col-sm-3 col-form-label">Banner<br><small class="text-muted">(183x123)</small></label>
                            <div class="col-sm-9">
                                <input class="form-control mb-2" type="file" wire:model="banner">
                                @error('banner')
                                    <span class="text-danger" style="font-size: 12.5px;">{{ $message }}</span>
