                                ...
                                <div class="col-xl-2">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <br>
                                            <p class="card-text">
                                               <img src="{{$Feature->banner}}" width="50"> {{$Feature->description}}
                                            </p>
                                        </div>
                                        <div class="card-footer" style="    border-top: solid #f3dcbc;">
                                            <small class="text-muted">{{date_format($Feature->created_at,'Y-M-d')}}</small>
                                            <br>
                                            <a type="button" href="#" class="btn btn-outline-success btn-icon-circle btn-icon-circle-sm"
                                               wire:click.prevent="editData({{ $Feature->id }})"><i class="ti ti-edit"></i></a>
                                            <a wire:click.prevent="deleteConfirmation({{ $Feature->id }})"
