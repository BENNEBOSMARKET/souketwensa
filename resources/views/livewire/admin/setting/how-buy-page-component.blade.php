                ...
                <div class="page-title-box">
                    <div class="float-end">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"> Edit How Buy  Page  </li>
                        </ol>
                    </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">All Description</h4>
                    ...
                    <div class="card-body">
                        <div class="row row-cols-1 row-cols-md-3 g-4">
                            ...
                            @foreach($howBuyPages as $howBuy)


                                    <div class="col-xl-2">
                                    <div class="card">

                                            <img src="{{$howBuy->banner}}" class="card-img-top" alt="Skyscrapers"/>

                                        <div class="card-body">
                                            <h5 class="card-title text-success"> {{$howBuy->title}}</h5>
                                            <br>
                                            <p class="card-text">
                                                {{$howBuy->description}}
                                            </p>
                                        ...
                                        <div class="card-footer" style="    border-top: solid #f3dcbc;">
                                            <small class="text-muted">{{date_format($howBuy->created_at,'Y-M-d')}}</small>
                                            <br>
                                            <a type="button" href="#" class="btn btn-outline-success btn-icon-circle btn-icon-circle-sm"
                                               wire:click.prevent="editData({{ $howBuy->id }})"><i class="ti ti-edit"></i></a>
                                            <a wire:click.prevent="deleteConfirmation({{ $howBuy->id }})"
