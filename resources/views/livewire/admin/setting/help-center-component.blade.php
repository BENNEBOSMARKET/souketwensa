<div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">All Help </h4>
                            ...
                            @foreach($HelpCenter as $Help)
                                ...
                                <div class="col-xl-2">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <h5 class="card-title text-success"> {{$Help->title}}</h5>
                                            <br>
                                            <p class="card-text">
                                               <IMG src="{{$Help->banner}}" width="50"> {{$Help->description}}
                                            </p>
                                        </div>
                                        <div class="card-footer" style="    border-top: solid #f3dcbc;">
                                            <small class="text-muted">{{date_format($Help->created_at,'Y-M-d')}}</small>
                                            <br>
                                            <a type="button" href="#" class="btn btn-outline-success btn-icon-circle btn-icon-circle-sm"
                                               wire:click.prevent="editData({{ $Help->id }})"><i class="ti ti-edit"></i></a>
                                            <a wire:click.prevent="deleteConfirmation({{ $Help->id }})"
        ...
        <div class="modal-dialog modal-dialog-centered modal-md">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Add New Help</h5>
    ...
    <div wire:ignore.self class="modal fade" id="editDataModal" data-bs-backdrop="static" data-bs-keyboard="false"
        ...
        <div class="modal-dialog modal-dialog-centered modal-md">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Edit Help</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
