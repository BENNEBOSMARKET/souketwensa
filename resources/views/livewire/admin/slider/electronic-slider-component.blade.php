<div>
                ...
                <div class="page-title-box">
                    <div class="float-end">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Electronic Slider</li>
                        </ol>
                    </div>
                    <h4 class="page-title">Electronic Slider</h4>
                </div>
            </div>
        </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">All Electronic Slider</h4>
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table custom_tbl">
                                ...
                                <tbody>
                                    @php
                                    $sl = ($electronicSliders->perPage() * $electronicSliders->currentPage())-($electronicSliders->perPage() - 1)
                                    @endphp
                                    @if ($electronicSliders->count() > 0)
                                    @foreach ($electronicSliders as $slider)
                                    <tr>
                                        <td>{{ $sl++ }}</td>
                                        ...
                                        <td style="text-align: center;">
                                            <div class="button-items">
                                                <a type="button" href="#" class="btn btn-sm btn-outline-success"
                                                    wire:click.prevent="editData({{ $slider->id }})">Edit</a>
                        ...
                        {{ $electronicSliders->links('pagination-links-table') }}
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Add New Electronic Slider</h5>
    ...
    <div wire:ignore.self class="modal fade" id="editDataModal" data-bs-backdrop="static" data-bs-keyboard="false"
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Edit Electronic Slider</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-8">
                                ...
                                @if ($banner)
                                    <img src="{{ $banner->temporaryUrl() }}" width="80" class="mt-2 mb-2" />
                                @elseif($new_banner != '')
                                    <img src="{{ asset('uploads/eslider') }}/{{ $new_banner }}" width="120"
                                        class="mt-2 mb-2" />
                                @endif
                            </div>
                        </div>
